...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">opentelemetry-angular-interceptor documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/HttpTextPropagatorService.html" data-type="entity-link">HttpTextPropagatorService</a>
                                </li>
                                <li class="link">
                                ...
                                <li class="link">
                                    <a href="injectables/SpanExporterService.html" data-type="entity-link">SpanExporterService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="interceptors-links"' : 'id="xs-interceptors-links"' }>
                            <li class="link">
                                <a href="interceptors/OpenTelemetryInterceptor.html" data-type="entity-link">OpenTelemetryInterceptor</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
